...
import {DRIVER_ACCOUNT} from '@env'
        ...
        <Screen style={tw`bg-white h-full justify-center`}>
            ...
            <View style={tw`self-center`}>
                ...
                <View style={tw`p-5 text-center self-center`}>
                    ...
                    <Text style={tw`text-base text-center`}>Driver Account: {DRIVER_ACCOUNT}</Text>
                    <Text style={tw`text-base text-center`}>Ride cost: {data?.price} eth</Text>
