...
import {DRIVER_ACCOUNT1, DRIVER_ACCOUNT2, DRIVER_ACCOUNT3} from '@env'
...
const data = [
    ...
    },
    {
        ...
        account: DRIVER_ACCOUNT3
    },
]

const SEARCH_CHARGE_RATE = 1.5
const ETH_CONVERSION_RATE = 0.00058
...
const RideOptionsCard = () => {
    ...
    const travelConst = (item) => {
        return ((travelTimeInformation?.duration?.value * SEARCH_CHARGE_RATE * ETH_CONVERSION_RATE * item?.multiplier) / 100)
    }
